...
WebUI.click(findTestObject('Object Repository/Page_NPRU Alumni/a'))

WebUI.click(findTestObject('search/Page_NPRU Alumni/button_id'))

WebUI.click(findTestObject('search/Page_NPRU Alumni/input__Std_ID'))

WebUI.setText(findTestObject('Object Repository/Page_NPRU Alumni/input__Std_ID'), '614259018')

WebUI.click(findTestObject('Object Repository/Page_NPRU Alumni/input__search'))

WebUI.verifyTextPresent('ธนายุทธ สามสังข์', false)
