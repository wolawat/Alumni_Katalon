...
WebUI.click(findTestObject('Object Repository/Page_NPRU Alumni/a__1'))

WebUI.setText(findTestObject('Object Repository/Page_NPRU Alumni/input__FName_LName'), 'ธนายุทธ')

WebUI.click(findTestObject('Object Repository/Page_NPRU Alumni/input__search'))

WebUI.verifyTextPresent('614259018', false)
