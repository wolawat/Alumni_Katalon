...
WebUI.click(findTestObject('search/Page_NPRU Alumni/button_classroom'))

WebUI.setText(findTestObject('Object Repository/Page_NPRU Alumni/input__classroom'), '61/100')

WebUI.click(findTestObject('Object Repository/Page_NPRU Alumni/input__search'))

WebUI.verifyTextPresent('61', false)
